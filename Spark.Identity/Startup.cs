...
using Spark.Identity;
using Spark.Identity.Services;
        ...
        public static IEnumerable<ApiResource> GetApiResources()
        {
            return new List<ApiResource>
            {
                new ApiResource("dataEventRecords")
                {
                    ...
                    UserClaims = { "id", "role", "admin", "user", "dataEventRecords", "dataEventRecords.admin", "dataEventRecords.user" }
                }
            };
        }
        ...
        public static IEnumerable<Client> GetClients()
        {
            return new List<Client>
            {
                new Client
                {
                    ...
                    Enabled = true,
                    ClientSecrets=  new List<Secret> { new Secret("apisecret".Sha256()) },
                    AllowedScopes = {
